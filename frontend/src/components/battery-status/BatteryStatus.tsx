      ...
      <div className="battery-status">
        {this.props.batteryStatus &&
          <svg width='75' height='30'>
            <rect width={this.BATTERY_MAX_WIDTH} height='25' fill='#666666' strokeWidth='1' stroke='#000'/>
            <rect width={this.calculateBatteryBarWidth()} height='25' fill='#32CD32' strokeWidth='1' stroke='#000'/>
            <rect x="50" y="5" width='3' height='15' fill='#666666' strokeWidth='1' stroke='#000'/>
            <text x="12" y="17" fill="white" font-size="13">{this.props.batteryStatus}%</text>
          </svg>}
      </div>
    );
  }
